...
const wallet = new Wallet(pk, bsc_provider);
 ...
 * UNICHAIN: 0x
 */
// const wl_bsc_data = bsc_contract.interface.encodeFunctionData("whitelist", [wallet.address]);
// const wl_unichain_data = unichain_contract.interface.encodeFunctionData("whitelist", [wallet.address]);

// const wl_bsc = await wallet.call({
//     to: bsc_contract_target,
//     data: wl_bsc_data
// });

// const wl_unichain = await wallet.call({
...
// const wl_bsc = await wallet.sendTransaction({
//     to: bsc_contract_target,
//     data: wl_bsc_data,
//     value: 0n
// }).catch((error) => {
...
// const wl_unichain = await wallet.sendTransaction({
//     to: unichain_contract_target,
//     data: wl_unichain_data,
//     value: 0n
// }).catch((error) => {
